  ...
  payload_size(32), dynamic_payloads_enabled(false), addr_width(5),csDelay(5)//,pipe0_reading_address(0)
{
  ...
  txDelay = 250 ;       // IBS Ian Shef  12 Apr 2017 to eliminate a bug warning.
  failureDetected = 1 ; // IBS Ian Shef  12 Apr 2017 to eliminate a bug warning.
  spi_speed = 0 ;       // IBS Ian Shef  12 Apr 2017 to eliminate a bug warning.
}
...
rf24_crclength_e RF24::getCRCLength(void)
{
  ...
  //  IBS Ian Shef 12 April 2017  Added parentheses around config & _BV(EN_CRC )
